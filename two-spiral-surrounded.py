...
# Clustered anomalies
a = np.random.normal(0, 0.5, 50)
b = np.random.normal(0, 0.5, 50)

pl.plot(d1[:,1], d1[:,0],'o', d2[:,1], d2[:,0],'o', a, b, 'o')
pl.show()

file = open('./two-spiral-surrounded.csv', 'w')
